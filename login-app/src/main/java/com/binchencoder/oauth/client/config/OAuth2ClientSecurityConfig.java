 ...
 */
package com.binchencoder.oauth.client.config;

import com.binchencoder.oauth.client.filter.JLogoutRecordFilter;
import com.binchencoder.oauth.client.filter.JUidCidTokenAuthenticationFilter;
import com.binchencoder.oauth.client.handler.JAccessDeniedHandler;
import com.binchencoder.oauth.client.handler.JAuthenticationEntryPoint;
import com.binchencoder.oauth.client.handler.JForwardAuthenticationSuccessHandler;
import com.binchencoder.oauth.client.matcher.JUidCidTokenRequestMatcher;
import com.binchencoder.oauth.client.route.Routes;
import com.binchencoder.oauth.client.service.AuthenticationFailureCountingService;
import com.binchencoder.oauth.client.service.JUserDetailsService;
import com.binchencoder.oauth.client.authentication.JUserNamePasswordAuthenticationProvider;
import com.binchencoder.oauth.client.filter.JAuthenticationServiceExceptionFilter;
import com.binchencoder.oauth.client.filter.JRequiredUserCheckFilter;
import com.binchencoder.oauth.client.filter.JUsernamePasswordAuthenticationFilter;
import com.binchencoder.oauth.client.handler.JAccessTokenResponseConverter;
import com.binchencoder.oauth.client.handler.JAuthorizationRequestResolver;
